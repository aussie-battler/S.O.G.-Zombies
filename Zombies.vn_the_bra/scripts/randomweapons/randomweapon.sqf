        ...
        [] spawn {
            ...
            if ([_cost] call BAC_fnc_scoreBuy) then {
                private _weapon = selectRandom [
                    ...
                    "vnx_fm2429","vnx_l1a1_05","vnx_m45_sf","vnx_m12_smg_fold","vnx_m50_smg_fold","vnx_m77e_shorty","vnx_stg44","vnx_m201z"
                ];
                ...
                [player, "buyweapon", 2] call BAC_fnc_playVoiceLine;
                player playAction "gestureFreeze";
...
//this is the old script, it works flawlessly without a buy function
/* _user10Key = actionKeysImages "User10";

titleText [format ["<t color='#ffffff' size='4'>Press</t><t color='#40ccd0' size='5'> %1</t><t color='#ffffff' size='4'> to pick a random gun</t>", _user10Key], "PLAIN NOFADE", -1, false, true];
...
addUserActionEventHandler ["User10", "Activate", {
    ...
    if (_activated) then {
		[] spawn {
        private _weapon = selectRandom ["vn_xm16e1", "vn_xm177e1", "vn_xm177_short", "vn_vz61", "vn_type64_smg", "vn_type56", "vn_sten", "vn_rpd_shorty_01", "vn_rpd_shorty", "vn_ppsh41", "vn_pps52", "vn_pps43", "vn_pk", "vn_mpu", "vn_mp40", "vn_mg42", "vn_mc10", "vn_mat49", "vn_m79", "vn_m63a", "vn_m60_shorty", "vn_m3a1", "vn_m2carbine", "vn_m1928_tommy", "vn_m1918", "vn_m1897", "vn_m16", "vn_m14a1_shorty", "vn_m1carbine", "vn_m45", "vn_l4", "vn_l2a3", "vn_l1a1_01", "vn_kbkg", "vn_k50m", "vn_izh54_shorty", "vn_gau5a", "vn_f1_smg", "vn_dp28", "vn_ak_01", "vnx_fm2429", "vnx_l1a1_05", "vnx_m45_sf", "vnx_m12_smg_fold", "vnx_m50_smg_fold", "vnx_m77e_shorty" ];
		removeAllMagazines player;
		player addWeapon _weapon;
